...
DATASETS_CONFIG = {
        ...
        'yumi': {
            'urls': ['http://www.ehu.es/ccwintco/uploads/7/72/yumidata.mat',
                     'http://www.ehu.es/ccwintco/uploads/5/58/yumilabel.mat'],
            'img': 'yumidata_new.mat',
            'gt': 'yumilabel_new2.mat'
        },
        "Salinas": {
        "urls": [
        ...
        "japan": {
        "urls": [
            "http://www.ehu.eus/ccwintco/uploads/a/a3/HyperspecVNIR_Chikusei_20140729.mat",
            "http://www.ehu.eus/ccwintco/uploads/f/fa/HyperspecVNIR_Chikusei_20140729_Ground_Truth.mat",
        ],
        ...
        "Houston13": {
        "urls": [
            "http://www.ehu.eus/ccwintco/uploads/a/a3/HustonU_IM.mat",
            "http://www.ehu.eus/ccwintco/uploads/f/fa/HustonU_gt.mat",
        ],
        "img": "HustonU_IM.mat",
        "gt": "HustonU_gt.mat",
        }
...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'PaviaC':
        ...
        img = open_file(folder + 'yumidata_new.mat')
        img = img['yumidata']

        rgb_bands = (70, 53, 19)

        gt = open_file(folder + 'yumilabel_new2.mat')['yumi_label']
        label_values = ["undefined", "bad_part", "good_part"]
        ...
        img = h5py.File((folder + "HyperspecVNIR_Chikusei_20140729.mat"), 'r')
        img = img['chikusei'][()]
        img = img.swapaxes(0, 2)

        rgb_bands = (43, 21, 11)  # AVIRIS sensor

        labels = open_file(folder + "HyperspecVNIR_Chikusei_20140729_Ground_Truth.mat")["GT"]
        ...
        img = open_file(folder + "HustonU_IM.mat")["hustonu"]

        rgb_bands = (43, 21, 11)  # AVIRIS sensor

        gt = open_file(folder + "HustonU_gt.mat")["hustonu_gt"]
    ...
    # Filter NaN out
    nan_mask = np.isnan(img.sum(axis=-1)) # 检查是否为空值
    ...
    data = img.reshape(np.prod(img.shape[:2]), np.prod(img.shape[2:])) # np.prod返回给定轴上的数组元素的乘积
...
class HyperX(torch.utils.data.Dataset):
    ...
    def __init__(self, data, gt, **hyperparams):
        ...
        np.random.shuffle(self.indices)  # 随机打乱数据
